...
import { syncEmailFromAuth } from '@/app/_actions/edit-email';
...
export default async function EmailUpdatedPage() {
  ...
  // Run the sync — Supabase has confirmed the email change at this point.
  ...
  return (
    <main className="bg-canvas flex-1 w-full flex flex-col items-center justify-center px-[32px] tab:px-[120px] desk:px-[320px] text-center">
      ...
      <p className="font-sans text-muted text-[15px] leading-[24px] tab:text-[16px] tab:leading-[26px] desk:text-[17px] desk:leading-[28px] max-w-[326px] tab:max-w-[480px] desk:max-w-[640px]">
        Your account email is now <span className="font-semibold text-ink">{profile.email as string}</span>.
      </p>
